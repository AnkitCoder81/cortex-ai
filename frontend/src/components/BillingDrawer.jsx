          ...
          const handleUpgrade = async (plan) => {
                   try{
                       ...
                       const options = {
                           ...
                           name:"CortexAI",
                           descrription:`${data?.plan?.name} Plan`,  
                    ...
                    <AnimatePresence>
                              ...
                              />
                                        ...
                                        <motion.div
                                                  ...
                                                  className="fixed right-0 top-0 z-50 h-screen w-[380px] bg-[#0f1117] border-l border-white/10 shadow-2xl flex
          flex-col"
                                        >
                                                  ...
                                                  <div className="flex items-center justify-between p-5 border-b border-white/10">
                                                            ...
                                                            <button onClick={onClose} className="w-9 h-9 rounded-lg bg-white/5 hover:bg-white/10 flex items-center 
         justify-center">
                                        ...
                                        <div className='px-5 flex-1 overflow-auto space-y-3'>
                                        {/* Starter Plan */}
                                        <div className='rounded-xl border border-white/10 p-4 bg-white/[0.04]'>
                                        <h3 className='text-white font-semibold'>Starter Plan</h3>
                                        <p className='text-indigo-400 text-2xl font-bold mt-2'>₹199</p>
                                        <p className='text-slate-400 text-sm mt-1'>500 Credits</p>
                                        <button className='mt-4 w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2 text-white cursor-pointer border-none'
